...
export const toolGroups: Record<ToolGroup, { i18nLabel: string; tools: ToolMeta[] }> = {
  essentials: {
    ...
    tools: [
      ...
      { slug: "remove-duplicate-lines", i18nKey: "removeDuplicateLines", icon: "Rd", badgeColor: "bg-rose-100 dark:bg-rose-950 text-rose-700 dark:text-rose-400", group: "essentials" },
      { slug: "remove-empty-lines", i18nKey: "removeEmptyLines", icon: "Re", badgeColor: "bg-pink-100 dark:bg-pink-950 text-pink-700 dark:text-pink-400", group: "essentials" },
      { slug: "remove-line-breaks", i18nKey: "removeLineBreaks", icon: "Rb", badgeColor: "bg-red-100 dark:bg-red-950 text-red-700 dark:text-red-400", group: "essentials" },
      { slug: "trim-text", i18nKey: "trimText", icon: "Tr", badgeColor: "bg-stone-100 dark:bg-stone-900 text-stone-700 dark:text-stone-400", group: "essentials" },
      { slug: "sort-lines", i18nKey: "sortLines", icon: "So", badgeColor: "bg-orange-100 dark:bg-orange-950 text-orange-700 dark:text-orange-400", group: "essentials" },
    ],
  },
  styles: {
  ...
  utilities: {
    ...
    tools: [
      ...
      { slug: "uuid-generator", i18nKey: "uuidGenerator", icon: "Ui", badgeColor: "bg-violet-100 dark:bg-violet-950 text-violet-700 dark:text-violet-400", group: "utilities", hasOutput: true },
      { slug: "password-generator", i18nKey: "passwordGenerator", icon: "Pw", badgeColor: "bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400", group: "utilities", hasOutput: true },
      { slug: "lorem-ipsum-generator", i18nKey: "loremIpsumGenerator", icon: "Li", badgeColor: "bg-indigo-100 dark:bg-indigo-950 text-indigo-700 dark:text-indigo-400", group: "utilities", hasOutput: true },
      { slug: "utm-generator", i18nKey: "utmGenerator", icon: "Ut", badgeColor: "bg-teal-100 dark:bg-teal-950 text-teal-700 dark:text-teal-400", group: "utilities" },
    ],
  },
  developer: {
    ...
    tools: [
      ...
      { slug: "json-formatter", i18nKey: "jsonFormatter", icon: "{ }", badgeColor: "bg-yellow-100 dark:bg-yellow-950 text-yellow-700 dark:text-yellow-400", group: "developer" },
      { slug: "html-formatter", i18nKey: "htmlFormatter", icon: "Ht", badgeColor: "bg-orange-100 dark:bg-orange-950 text-orange-700 dark:text-orange-400", group: "developer" },
      { slug: "css-formatter", i18nKey: "cssFormatter", icon: "Cs", badgeColor: "bg-blue-100 dark:bg-blue-950 text-blue-700 dark:text-blue-400", group: "developer" },
      { slug: "javascript-formatter", i18nKey: "javascriptFormatter", icon: "Js", badgeColor: "bg-amber-100 dark:bg-amber-950 text-amber-700 dark:text-amber-400", group: "developer" },
      { slug: "yaml-formatter", i18nKey: "yamlFormatter", icon: "Ym", badgeColor: "bg-red-100 dark:bg-red-950 text-red-700 dark:text-red-400", group: "developer" },
      { slug: "markdown-formatter", i18nKey: "markdownFormatter", icon: "Md", badgeColor: "bg-sky-100 dark:bg-sky-950 text-sky-700 dark:text-sky-400", group: "developer" },
      { slug: "regex-tester", i18nKey: "regexTester", icon: ".*", badgeColor: "bg-purple-100 dark:bg-purple-950 text-purple-700 dark:text-purple-400", group: "developer" },
    ],
  },
};
