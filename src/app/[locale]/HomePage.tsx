        ...
        <div className="flex-1 min-w-0">
          <div className="rounded-2xl border border-slate-200/60 dark:border-slate-700/80 bg-white/80 dark:bg-slate-900/70 backdrop-blur-xl shadow-sm overflow-hidden">
            ...
            <textarea
              ...
              rows={12}
              className="w-full resize-y border-0 bg-transparent px-4 py-4 text-base leading-relaxed text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-0"
            ...
            <div className="flex items-center gap-2 px-4 py-2.5 border-t border-slate-200/50 dark:border-slate-700/60 bg-slate-50/30 dark:bg-slate-800/20">
              <button
                onClick={handleCopy}
                disabled={!hasContent && !output}
                className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200/80 dark:border-slate-700 bg-white/90 dark:bg-slate-800 px-3 py-1.5 text-xs font-medium text-slate-600 dark:text-slate-300 transition-all hover:bg-slate-50 dark:hover:bg-slate-700 hover:border-slate-300 dark:hover:border-slate-600 disabled:opacity-40 disabled:cursor-not-allowed"
              >
                {copied ? (
              ...
              <button
                ...
                className="lg:hidden inline-flex items-center gap-1 rounded-lg px-2 py-1.5 text-xs text-slate-400 hover:text-slate-600 dark:text-slate-500 dark:hover:text-slate-300 transition-colors"
              >
          ...
          <div className="mt-4">
            <div className="flex gap-1 mb-3 border-b border-slate-200/50 dark:border-slate-700/60">
              ...
              {currentTools.map((tool) => {
                ...
                return (
                  <button
                    ...
                    disabled={isDisabled}
                    className={`flex items-center gap-2 rounded-xl border px-2.5 py-2 text-xs font-semibold transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed ${
                      isActive
                  ...
                  >
                    <span className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-md text-[10px] font-bold ${tool.badgeColor}`}>
                      {tool.icon}
                    </span>
                    {t(`home.transforms.${tool.i18nKey}`)}
                  </button>
                );
              })}
            </div>
